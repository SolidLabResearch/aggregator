...
const SERVICES_ENDPOINT = "http://aggregator.local/f00141b4-cc61-4fee-a4af-1263ef2ffe8d/services";
...
const DESCRIPTION = `
@base <http://aggregator.local/f00141b4-cc61-4fee-a4af-1263ef2ffe8d/> .
